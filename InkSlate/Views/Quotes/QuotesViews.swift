...
fileprivate let quotesLog = Logger(subsystem: "com.lucas.InkSlateNew", category: "Quotes")
...
struct ModernQuoteCard: View {
    ...
    private func toggleFavorite() {
        ...
        viewContext.inkSlateSave(module: "Quotes")
    }
    ...
    private func deleteQuote() {
        ...
        if !viewContext.inkSlateSave(module: "Quotes") {
...
struct ModernAddQuoteView: View {
    ...
    private func saveQuote() {
        ...
        if viewContext.inkSlateSave(module: "Quotes", retry: { saveQuote() }) {
            dismiss()
        }
    }
}
...
struct ModernEditQuoteView: View {
    ...
    private func saveChanges() {
        ...
        if viewContext.inkSlateSave(module: "Quotes", retry: { saveChanges() }) {
            dismiss()
        }
    }
}
