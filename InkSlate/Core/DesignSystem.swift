...
struct DesignSystem {
    ...
    // MARK: - Colors
    struct Colors {
        static var accent: Color { ThemeService.shared.accentColor }
        static var accentLight: Color { ThemeService.shared.accentColor.opacity(0.75) }
        static var accentDark: Color { ThemeService.shared.accentColor.opacity(0.95) }
